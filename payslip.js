...
.logo-box{background:linear-gradient(145deg,#2C1A00,#C9952A);width:90px;flex-shrink:0;display:flex;align-items:center;justify-content:center;padding:10px}
.logo-inner{background:rgba(255,255,255,0.15);border-radius:50%;width:68px;height:68px;display:flex;flex-direction:column;align-items:center;justify-content:center;border:2px solid rgba(255,255,255,0.3)}
.logo-tp{font-size:22px;font-weight:900;color:#fff;line-height:1}
.logo-cb{font-size:15px;font-weight:700;color:#FFD580;line-height:1}
